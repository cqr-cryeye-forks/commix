...
def eb_injection_handler(url, timesec, filename, http_request_method, injection_type, technique):
    ...
    total = len(settings.WHITESPACES) * len(settings.EVAL_PREFIXES) * len(settings.EVAL_SEPARATORS) * len(
                ...
                for separator in settings.EVAL_SEPARATORS:
                    ...
                    if shell:
                        ...
                        if settings.ENUMERATION_DONE == True:
                            while True:
                                ...
                                if enumerate_again in settings.CHOICE_YES:
                                    eb_enumeration.do_check(separator, TAG, prefix, suffix, whitespace,
                            ...
                            if menu.enumeration_options():
                                eb_enumeration.do_check(separator, TAG, prefix, suffix, whitespace, http_request_method,
                        ...
                        if settings.FILE_ACCESS_DONE == True:
                            ...
                            while True:
                                ...
                                if file_access_again in settings.CHOICE_YES:
                                    eb_file_access.do_check(separator, TAG, prefix, suffix, whitespace,
                                                            http_request_method, url, vuln_parameter, alter_shell,
                                                            filename, timesec)
                                    print(settings.SINGLE_WHITESPACE)
                                    break
                            ...
                            if menu.file_access_options():
                                ...
                                #   print(settings.SINGLE_WHITESPACE)
                                eb_file_access.do_check(separator, TAG, prefix, suffix, whitespace, http_request_method,
                                                        url, vuln_parameter, alter_shell, filename, timesec)
                                print(settings.SINGLE_WHITESPACE)
                        ...
                        if menu.options.os_cmd:
                            ...
                            #   print(settings.SINGLE_WHITESPACE)
                            eb_enumeration.single_os_cmd_exec(separator, TAG, prefix, suffix, whitespace,
                                                              http_request_method, url, vuln_parameter, alter_shell,
                                                              filename, timesec)
